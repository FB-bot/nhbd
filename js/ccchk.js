...
checkBtn.addEventListener("click", function () {
  ...
  for (let i = 0; i < numberArray.length; i++) {
    ...
    if (!isValidCreditCard(cardNumber)) {
      muradList.push(`<span style='color:grey; font-weight:bold;'>Invalid (Luhn Check)</span> | ${line} /noobxvau`);
    ...
    if (randomNumber < 0.2) {
      aliList.push(`<span style='color:green; font-weight:bold;'>Live</span> | ${line} -> [Charge <span style='color:green; font-weight:bold;'>$4,99</span>] [GATE:01]. /noobxvau`);
    } else if (randomNumber < 0.9) {
      muhammadList.push(`<span style='color:red; font-weight:bold;'>Dead</span> | ${line} -> [Charge <span style='color:red; font-weight:bold;'>$0,00</span>] [GATE:01]. /noobxvau`);
    } else {
      muradList.push(`<span style='color:orange; font-weight:bold;'>Unknown</span> | ${line} -> [Charge <span style='color:orange; font-weight:bold;'>N/A</span>] [GATE:01]. /noobxvau`);
    }
  } 
